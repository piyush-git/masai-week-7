  ...
  return (
    <div className="mb-5 row ml-5">
        <div className="col-lg-4 ml-2">
            <h3 className="gray mb-4 ml-5">Unbeatable pricing</h3>
            <h6 className="gray mb-4 ml-5">We pioneered the concept of discount broking and price transparency in India. Flat fees and no hidden charges.</h6>
            <a href="">
                <h6 className="text-primary ml-5">See Pricing</h6>
            </a>
        </div>
        <div className="col-lg-7 col-sm-12 row text-center gray offset-lg-1">
            <div className="col-lg-4 border border-secondary ml-5">
